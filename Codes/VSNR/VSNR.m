% function [u,Gap,Primal,Dual,EstP,EstD]=VSNR(u0,eps,p,Gabor,alpha,prec,C,[EstP,EstD])
%
...
function [u,Gap,Primal,Dual,EstP,EstD]=VSNR(u0,eps,p,Gabor,alpha,prec,C,varargin)
